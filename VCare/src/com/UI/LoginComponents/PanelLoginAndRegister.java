...
package com.UI.LoginComponents;

import com.UI.Components.Button;
import com.UI.Components.Combobox;
import com.UI.Components.MyPasswordField;
import com.UI.Components.MyTextField;
...
public class PanelLoginAndRegister extends javax.swing.JLayeredPane {
    ...
    private void initRegister(ActionListener eventRegister) {
        ...
        txtUser.setPrefixIcon(new ImageIcon(getClass().getResource("/com/vcare/icon/user.png")));
        txtUser.setHint("Name");
        register.add(txtUser, "w 60%");
        MyTextField txtEmail = new MyTextField();
        txtEmail.setPrefixIcon(new ImageIcon(getClass().getResource("/com/vcare/icon/mail.png")));
